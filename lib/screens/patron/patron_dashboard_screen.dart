      ...
      appBar: AppBar(
        ...
        actions: [
          PopupMenuButton<String>(
            ...
            itemBuilder: (_) => const [
              PopupMenuItem(value: '/patron/utilisateurs', child: Text('Créer / gérer utilisateurs')),
              PopupMenuItem(value: '/patron/catalogue', child: Text('Travaux (lavage, repassage…)')),
              PopupMenuItem(value: '/patron/facture', child: Text('En-tête facture PDF')),
              PopupMenuItem(value: '/patron/operations', child: Text('Toutes les opérations')),
            ],
          ),
